...
<form enctype='multipart/form-data' id="event-form" method="post" action="<?php echo esc_url(add_query_arg(array('success'=>null))); ?>">
	<div class="wrap">
		...
		<h3 class="event-form-when"><?php esc_html_e( 'Dates and time', 'dogium'); ?></h3>
		...
		<h3 class="event-form-where"><?php esc_html_e( 'Location', 'dogium'); ?></h3>
	...
	<p class="submit">
	    ...
	    <input type='submit' class='button small' value='<?php echo esc_attr__('Submit event', 'dogium'); ?>' />
	    <?php else: ?>
	    <input type='submit' class='button small' value='<?php echo esc_attr__('Update event', 'dogium'); ?>' />
	    <?php endif; ?>
	</p>
